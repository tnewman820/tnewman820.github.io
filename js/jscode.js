var urlBase = 'https://branchout.space/LAMPAPI';
var extension = 'php';
...
//	var jsonPayload = '{"login" : "' + login + '", "password" : "' + hash + '"}';
	var jsonPayload = '{"login" : "' + login + '", "password" : "' + hash + '", "firstname" : "' + fname + '", "lastname" : "' + lname + '","email" : "' + email + '","phone" : "' + phonenum + '"}';
...
function doCreateContact()
{
	...
	var email = document.getElementById("cemailAddress").value;
	var phonenum = document.getElementById("cphoneNumber").value;
	...
	try
	{
		...
		document.getElementById("createResult").innerHTML = "" + contactFirstName + " " + contactLastName + " Added successfully!";
		window.location.href = "/user";
	}
	catch(err)
	{
...
function searchContact()
{
	...
	var jsonPayload = '{"searchText" : "' + srch + '","userId" : ' + userId + '}';
	...
	try
	{
		...
		xhr.send(jsonPayload);
		document.getElementById("contactSearchResult").innerHTML ="Contacts retrieved:<br><br>";				
	}
	catch(err)
	{
